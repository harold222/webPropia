$(document).ready(function () {
    ...
    const DarkOrWhite = document.querySelector('#darkMode');
     ...
     DarkOrWhite.addEventListener('click', () => {
        ...
        const cadenaLogo = document.getElementById("imagenLogo").src;
        var n = cadenaLogo.search("Dark");/* si tiene el logo dark */
        if (n < 0)
            document.getElementById("imagenLogo").src="img/logo-Dark.png";
        else
